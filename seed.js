...
seeder.connect(
  "mongodb+srv://wikudev:daru161199@cluster0.8ttdqiw.mongodb.net/db_cerita?retryWrites=true&w=majority",
  {
...
var data = [
  ...
  // start item
  {
    ...
    documents: [
      ...
      // done
      {
        ...
        commentId: [
          { _id: mongoose.Types.ObjectId("5e96cbe292b97300fc90ab01") },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    documents: [
      {
        _id: mongoose.Types.ObjectId("5e96cbe292b97300fc903232"),
        email: "admin@gmail.com",
